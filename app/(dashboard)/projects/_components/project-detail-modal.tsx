...
export function ProjectDetailModal({ project, isOpen, onClose, onUpdateStatus }: ProjectDetailModalProps) {
  ...
  const [editableJustificacionAdministrativa, setEditableJustificacionAdministrativa] = useState("Integrar un módulo financiero permitirá validar cotizaciones, aprobar o rechazar costos y calcular retenciones impositivas Ley 843 en tiempo real, transparentando la ejecución presupuestaria.");

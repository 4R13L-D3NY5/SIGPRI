...
const FLOW_SCENARIOS = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description: "El proyecto obtiene puntaje aprobatorio (>80/100). Se emite la resolución institucional, se autoriza el desembolso y se activa el seguimiento del cronograma WBS.",
        responsibleRole: "Comisión / Contabilidad",
      ...
      },
      {
        ...
        responsibleRole: "Dirección de Investigación / Universidad",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        responsibleRole: "Dirección de Investigación / Investigador",
